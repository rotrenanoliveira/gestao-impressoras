...
import { RegisterMobileDeviceUseCase } from './register-mobile-device'
...
let sut: RegisterMobileDeviceUseCase
...
describe('Register mobile device', () => {
  beforeEach(() => {
    ...
    sut = new RegisterMobileDeviceUseCase(mobileDevicesRepository, contractsRepository, departmentsRepository)
  })
