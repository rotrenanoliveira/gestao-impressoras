...
interface CreateUserLicenseUseCaseProps {
  licenseId: string
  userId: string | null
  departmentId: string | null
}

type CreateUserLicenseUseCaseResponse = Either<ResourceNotFoundError, { userLicense: UserLicense }>
...
export class CreateUserLicenseUseCase implements UseCase {
  ...
  async execute({
    ...
    userId,
    departmentId,
  }: CreateUserLicenseUseCaseProps): Promise<CreateUserLicenseUseCaseResponse> {
